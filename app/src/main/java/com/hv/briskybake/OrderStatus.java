...
public class OrderStatus extends AppCompatActivity {
    ...
    private void loadOrders(String phoneNumber) {
        FirebaseRecyclerOptions<Request> options=new FirebaseRecyclerOptions.Builder<Request>().setQuery(requests.orderByChild("phone").equalTo(phoneNumber),Request.class).build();
